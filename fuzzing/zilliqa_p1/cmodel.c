...
void Ownable_Method_For_ZilliqaToken_bad(
    ...
    sol_uint256_t blocknum, sol_uint256_t timestamp, sol_bool_t paid,
    sol_address_t origin, sol_address_t func_user_newOwner) {
  sol_require(((sender).v) != (g_literal_address_291), 0);
  ((self->user_owner).v) = ((func_user_newOwner).v);
}
...
void run_model(void) {
  ...
  }
  {
    ...
    Init_ZilliqaToken(
        ...
        Init_sol_address_t(GET_ND_RANGE(42, 0, 8, "ZilliqaToken:_admin")),
        Init_sol_uint256_t(
            GET_ND_UINT(43, 256, "ZilliqaToken:_totalTokenAmount")));
  }
  smartace_log("[Entering transaction loop]");
  while (sol_continue()) {
    sol_on_transaction();
    sol_address_t last = contract_1.user_owner;
    ...
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(119, 0, 13, "next_call"));
    switch (next_call) {
    case 0: {
    ...
    case 3: {
      ...
      ((value).v) = (0);
      sol_address_t arg__from =
          Init_sol_address_t(GET_ND_RANGE(10, 0, 8, "_from"));
      sol_uint256_t arg__value =
    ...
    case 4: {
      ...
      sol_address_t arg_newAdmin =
          Init_sol_address_t(GET_ND_RANGE(13, 0, 8, "newAdmin"));
    ...
    case 5: {
      ...
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(15, 0, 8, "_spender"));
      sol_uint256_t arg__value =
    ...
    case 6: {
      ...
      ((value).v) = (0);
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(18, 0, 8, "_spender"));
    ...
    case 7: {
      ...
      ((value).v) = (0);
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(21, 0, 8, "_spender"));
    ...
    case 9: {
      ...
      sol_address_t arg_newOwner =
          Init_sol_address_t(GET_ND_RANGE(27, 0, 8, "newOwner"));
    ...
    case 10: {
      smartace_log("[Calling bad(newOwner) on contract_1]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(28, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_newOwner =
          Init_sol_address_t(GET_ND_RANGE(29, 0, 8, "newOwner"));
      Ownable_Method_For_ZilliqaToken_bad(&(contract_1), sender, value,
    ...
    case 11: {
      ...
      sol_address_t arg__owner =
          Init_sol_address_t(GET_ND_RANGE(31, 0, 8, "_owner"));
      sol_address_t arg__spender =
    ...
    case 12: {
      ...
      ((value).v) = (0);
      sol_address_t arg__owner =
          Init_sol_address_t(GET_ND_RANGE(34, 0, 8, "_owner"));
