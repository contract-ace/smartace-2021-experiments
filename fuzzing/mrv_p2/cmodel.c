  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      (((contract_1).user___balances).data_0) =
          (Init_sol_uint256_t(GET_ND_UINT(52, 256, "MRVToken::_balances::_0")));
      (((contract_1).user___balances).data_1) =
          (Init_sol_uint256_t(GET_ND_UINT(53, 256, "MRVToken::_balances::_1")));
      (((contract_1).user___balances).data_2) =
          (Init_sol_uint256_t(GET_ND_UINT(54, 256, "MRVToken::_balances::_2")));
      (((contract_1).user___balances).data_3) =
          (Init_sol_uint256_t(GET_ND_UINT(55, 256, "MRVToken::_balances::_3")));
      (((contract_1).user___balances).data_4) =
          (Init_sol_uint256_t(GET_ND_UINT(56, 256, "MRVToken::_balances::_4")));
      (((contract_1).user___balances).data_5) =
          (Init_sol_uint256_t(GET_ND_UINT(57, 256, "MRVToken::_balances::_5")));
      (((contract_1).user___balances).data_6) =
          (Init_sol_uint256_t(GET_ND_UINT(58, 256, "MRVToken::_balances::_6")));
      (((contract_1).user___allowed).data_0_0) = (Init_sol_uint256_t(
          GET_ND_UINT(59, 256, "MRVToken::_allowed::_0_0")));
      (((contract_1).user___allowed).data_0_1) = (Init_sol_uint256_t(
          GET_ND_UINT(60, 256, "MRVToken::_allowed::_0_1")));
    ...
    if (contract_1.user_crowdsaleEnded.v != 0)
    {
      sol_assert(last.v == contract_1.user___totalSupply.v, 0);
    }
  }
}