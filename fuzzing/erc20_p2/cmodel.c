  ...
  Write_Map_1(
      ...
      Init_sol_uint256_t(
          (SafeMath_Method_add(
               ...
               Init_sol_uint256_t((func_user_amount).v)))
              .v));
  Write_Map_1(&(self->user___balances),
              Init_sol_address_t(g_literal_address_291), Init_sol_uint256_t(0));
  {
    (func_user_sender).v;
...
void run_model(void) {
  ...
  (g_literal_address_291) = (GET_ND_RANGE(35, 1, 8, "g_literal_address_291"));
  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      ((((contract_1).user___minters).user_bearer).data_0) = (Init_sol_bool_t(
          GET_ND_RANGE(40, 0, 2, "Token::_minters::bearer::_0")));
      ((((contract_1).user___minters).user_bearer).data_1) = (Init_sol_bool_t(
          GET_ND_RANGE(41, 0, 2, "Token::_minters::bearer::_1")));
      ((((contract_1).user___minters).user_bearer).data_2) = (Init_sol_bool_t(
          GET_ND_RANGE(42, 0, 2, "Token::_minters::bearer::_2")));
      ((((contract_1).user___minters).user_bearer).data_3) = (Init_sol_bool_t(
          GET_ND_RANGE(43, 0, 2, "Token::_minters::bearer::_3")));
      ((((contract_1).user___minters).user_bearer).data_4) = (Init_sol_bool_t(
          GET_ND_RANGE(44, 0, 2, "Token::_minters::bearer::_4")));
      ((((contract_1).user___minters).user_bearer).data_5) = (Init_sol_bool_t(
          GET_ND_RANGE(45, 0, 2, "Token::_minters::bearer::_5")));
      ((((contract_1).user___minters).user_bearer).data_6) = (Init_sol_bool_t(
          GET_ND_RANGE(46, 0, 2, "Token::_minters::bearer::_6")));
      ((((contract_1).user___minters).user_bearer).data_7) = (Init_sol_bool_t(
          GET_ND_RANGE(47, 0, 2, "Token::_minters::bearer::_7")));
      (((contract_1).user___balances).data_0) =
          (Init_sol_uint256_t(GET_ND_UINT(48, 256, "Token::_balances::_0")));
      (((contract_1).user___balances).data_1) =
          (Init_sol_uint256_t(GET_ND_UINT(49, 256, "Token::_balances::_1")));
      (((contract_1).user___balances).data_2) =
          (Init_sol_uint256_t(GET_ND_UINT(50, 256, "Token::_balances::_2")));
      (((contract_1).user___balances).data_3) =
          (Init_sol_uint256_t(GET_ND_UINT(51, 256, "Token::_balances::_3")));
      (((contract_1).user___balances).data_4) =
          (Init_sol_uint256_t(GET_ND_UINT(52, 256, "Token::_balances::_4")));
      (((contract_1).user___balances).data_5) =
          (Init_sol_uint256_t(GET_ND_UINT(53, 256, "Token::_balances::_5")));
      (((contract_1).user___balances).data_6) =
          (Init_sol_uint256_t(GET_ND_UINT(54, 256, "Token::_balances::_6")));
      (((contract_1).user___balances).data_7) =
          (Init_sol_uint256_t(GET_ND_UINT(55, 256, "Token::_balances::_7")));
    ...
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(123, 0, 15, "next_call"));
    switch (next_call) {
    case 0: {
    ...
    case 8: {
      ...
      ((value).v) = (0);
      sol_address_t arg_account =
          Init_sol_address_t(GET_ND_RANGE(13, 0, 8, "account"));
    ...
    case 9: {
      ...
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(15, 0, 8, "recipient"));
      sol_uint256_t arg_amount =
          Init_sol_uint256_t(GET_ND_UINT(16, 256, "amount"));
      sol_uint256_t last = Read_Map_1(&contract_1.user___balances, Init_sol_address_t(g_literal_address_291));
      ERC20_Method_For_Token_transfer(&(contract_1), sender, value, blocknum,
                                      timestamp, paid, sender, arg_recipient,
                                      arg_amount);
      sol_uint256_t next = Read_Map_1(&contract_1.user___balances, Init_sol_address_t(g_literal_address_291));
      if (last.v > next.v) {
        sol_assert(g_literal_address_291 == sender.v, 0);
      }
      smartace_log("[Call successful]");
      break;
    }
    case 10: {
      ...
      sol_address_t arg_owner =
          Init_sol_address_t(GET_ND_RANGE(18, 0, 8, "owner"));
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(19, 0, 8, "spender"));
    ...
    case 12: {
      ...
      sol_address_t arg_sender =
          Init_sol_address_t(GET_ND_RANGE(24, 0, 8, "sender"));
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(25, 0, 8, "recipient"));
      sol_uint256_t arg_amount =
    ...
    case 13: {
      ...
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(28, 0, 8, "spender"));
    ...
    case 14: {
      ...
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(31, 0, 8, "spender"));
