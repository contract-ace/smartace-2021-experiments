...
void ERC20Detailed_Method_For_Token_rename(
    struct Token *self, sol_address_t sender, sol_uint256_t value,
    sol_uint256_t blocknum, sol_uint256_t timestamp, sol_bool_t paid,
    sol_address_t origin, sol_uint8_t func_user_d) {
  ((self->user___decimals).v) = ((func_user_d).v);
}
sol_uint256_t
  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      ...
      ((((contract_1).user___minters).user_bearer).data_6) = (Init_sol_bool_t(
          GET_ND_RANGE(47, 0, 2, "Token::_minters::bearer::_6")));
    ...
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(107, 0, 16, "next_call"));
    switch (next_call) {
    case 0: {
    ...
    case 7: {
      smartace_log("[Calling rename(d) on contract_1]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(11, 2, 7, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_uint8_t arg_d = Init_sol_uint8_t(GET_ND_UINT(12, 8, "d"));
      ERC20Detailed_Method_For_Token_rename(&(contract_1), sender, value,
                                            blocknum, timestamp, paid, sender,
                                            arg_d);
      smartace_log("[Call successful]");
      break;
    ...
    case 9: {
      ...
      ((value).v) = (0);
      sol_address_t arg_account =
          Init_sol_address_t(GET_ND_RANGE(15, 0, 7, "account"));
    ...
    case 10: {
      ...
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(17, 0, 7, "recipient"));
      sol_uint256_t arg_amount =
    ...
    case 11: {
      ...
      sol_address_t arg_owner =
          Init_sol_address_t(GET_ND_RANGE(20, 0, 7, "owner"));
    ...
    sol_assert(last.v == contract_1.user___symbol.v, 0);
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_sender =
          Init_sol_address_t(GET_ND_RANGE(26, 0, 7, "sender"));
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(27, 0, 7, "recipient"));
      sol_uint256_t arg_amount =
