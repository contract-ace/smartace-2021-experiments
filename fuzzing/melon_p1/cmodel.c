...
sol_bool_t ERC20_Method_For_Melon_bad(
    struct Melon *self, sol_address_t sender, sol_uint256_t value,
    sol_uint256_t blocknum, sol_uint256_t timestamp, sol_bool_t paid,
    sol_address_t origin, sol_address_t func_user_from,
    sol_address_t func_user_to, sol_uint256_t func_user_value) {
  g_literal_address_1;
  {
    return Init_sol_bool_t(
        (ERC20_Method_For_Melon_transferFrom(
             self, sender, value, blocknum, timestamp, Init_sol_bool_t(0),
             origin, Init_sol_address_t((func_user_from).v),
             Init_sol_address_t((func_user_to).v),
             Init_sol_uint256_t((func_user_value).v)))
            .v);
  }
...
void run_model(void) {
  ...
  (g_literal_address_1) = (GET_ND_RANGE(41, 1, 8, "g_literal_address_1"));
  (((contract_1).model_address).v) = (1);
  (((contract_1).user_council).v) = (0);
  (((contract_1).user_deployer).v) = (0);
  smartace_log("[Initializing contract_1]");
  if (GET_ND_RANGE(44, 0, 2, "take_step")) {
    ((blocknum).v) = (GET_ND_INCREASE(42, (blocknum).v, 1, "blocknum"));
    ((timestamp).v) = (GET_ND_INCREASE(43, (timestamp).v, 1, "timestamp"));
  }
  {
    sol_address_t sender;
    ((sender).v) = (GET_ND_RANGE(45, 2, 8, "sender"));
    ((last_sender).v) = ((sender).v);
    sol_uint256_t value;
    ((value).v) = (0);
    Init_Melon(&(contract_1), sender, value, blocknum, timestamp, paid, sender,
               Init_sol_uint256_t(GET_ND_UINT(46, 256, "Melon:_name")),
               Init_sol_uint256_t(GET_ND_UINT(47, 256, "Melon:_symbol")),
               Init_sol_uint8_t(GET_ND_UINT(48, 8, "Melon:_decimals")),
               Init_sol_address_t(GET_ND_RANGE(49, 0, 8, "Melon:_council")));
  }
  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      (((contract_1).user___balances).data_0) =
          (Init_sol_uint256_t(GET_ND_UINT(50, 256, "Melon::_balances::_0")));
      (((contract_1).user___balances).data_1) =
          (Init_sol_uint256_t(GET_ND_UINT(51, 256, "Melon::_balances::_1")));
      (((contract_1).user___balances).data_2) =
          (Init_sol_uint256_t(GET_ND_UINT(52, 256, "Melon::_balances::_2")));
      (((contract_1).user___balances).data_3) =
          (Init_sol_uint256_t(GET_ND_UINT(53, 256, "Melon::_balances::_3")));
      (((contract_1).user___balances).data_4) =
          (Init_sol_uint256_t(GET_ND_UINT(54, 256, "Melon::_balances::_4")));
      (((contract_1).user___balances).data_5) =
          (Init_sol_uint256_t(GET_ND_UINT(55, 256, "Melon::_balances::_5")));
      (((contract_1).user___balances).data_6) =
          (Init_sol_uint256_t(GET_ND_UINT(56, 256, "Melon::_balances::_6")));
      (((contract_1).user___balances).data_7) =
          (Init_sol_uint256_t(GET_ND_UINT(57, 256, "Melon::_balances::_7")));
      (((contract_1).user___allowed).data_0_0) =
          (Init_sol_uint256_t(GET_ND_UINT(58, 256, "Melon::_allowed::_0_0")));
      (((contract_1).user___allowed).data_0_1) =
          (Init_sol_uint256_t(GET_ND_UINT(59, 256, "Melon::_allowed::_0_1")));
      (((contract_1).user___allowed).data_0_2) =
          (Init_sol_uint256_t(GET_ND_UINT(60, 256, "Melon::_allowed::_0_2")));
      (((contract_1).user___allowed).data_0_3) =
          (Init_sol_uint256_t(GET_ND_UINT(61, 256, "Melon::_allowed::_0_3")));
      (((contract_1).user___allowed).data_0_4) =
          (Init_sol_uint256_t(GET_ND_UINT(62, 256, "Melon::_allowed::_0_4")));
      (((contract_1).user___allowed).data_0_5) =
          (Init_sol_uint256_t(GET_ND_UINT(63, 256, "Melon::_allowed::_0_5")));
      (((contract_1).user___allowed).data_0_6) =
          (Init_sol_uint256_t(GET_ND_UINT(64, 256, "Melon::_allowed::_0_6")));
      (((contract_1).user___allowed).data_0_7) =
          (Init_sol_uint256_t(GET_ND_UINT(65, 256, "Melon::_allowed::_0_7")));
      (((contract_1).user___allowed).data_1_0) =
          (Init_sol_uint256_t(GET_ND_UINT(66, 256, "Melon::_allowed::_1_0")));
      (((contract_1).user___allowed).data_1_1) =
          (Init_sol_uint256_t(GET_ND_UINT(67, 256, "Melon::_allowed::_1_1")));
      (((contract_1).user___allowed).data_1_2) =
          (Init_sol_uint256_t(GET_ND_UINT(68, 256, "Melon::_allowed::_1_2")));
      (((contract_1).user___allowed).data_1_3) =
          (Init_sol_uint256_t(GET_ND_UINT(69, 256, "Melon::_allowed::_1_3")));
      (((contract_1).user___allowed).data_1_4) =
          (Init_sol_uint256_t(GET_ND_UINT(70, 256, "Melon::_allowed::_1_4")));
      (((contract_1).user___allowed).data_1_5) =
          (Init_sol_uint256_t(GET_ND_UINT(71, 256, "Melon::_allowed::_1_5")));
      (((contract_1).user___allowed).data_1_6) =
          (Init_sol_uint256_t(GET_ND_UINT(72, 256, "Melon::_allowed::_1_6")));
      (((contract_1).user___allowed).data_1_7) =
          (Init_sol_uint256_t(GET_ND_UINT(73, 256, "Melon::_allowed::_1_7")));
      (((contract_1).user___allowed).data_2_0) =
          (Init_sol_uint256_t(GET_ND_UINT(74, 256, "Melon::_allowed::_2_0")));
      (((contract_1).user___allowed).data_2_1) =
          (Init_sol_uint256_t(GET_ND_UINT(75, 256, "Melon::_allowed::_2_1")));
      (((contract_1).user___allowed).data_2_2) =
          (Init_sol_uint256_t(GET_ND_UINT(76, 256, "Melon::_allowed::_2_2")));
      (((contract_1).user___allowed).data_2_3) =
          (Init_sol_uint256_t(GET_ND_UINT(77, 256, "Melon::_allowed::_2_3")));
      (((contract_1).user___allowed).data_2_4) =
          (Init_sol_uint256_t(GET_ND_UINT(78, 256, "Melon::_allowed::_2_4")));
      (((contract_1).user___allowed).data_2_5) =
          (Init_sol_uint256_t(GET_ND_UINT(79, 256, "Melon::_allowed::_2_5")));
      (((contract_1).user___allowed).data_2_6) =
          (Init_sol_uint256_t(GET_ND_UINT(80, 256, "Melon::_allowed::_2_6")));
      (((contract_1).user___allowed).data_2_7) =
          (Init_sol_uint256_t(GET_ND_UINT(81, 256, "Melon::_allowed::_2_7")));
      (((contract_1).user___allowed).data_3_0) =
          (Init_sol_uint256_t(GET_ND_UINT(82, 256, "Melon::_allowed::_3_0")));
      (((contract_1).user___allowed).data_3_1) =
          (Init_sol_uint256_t(GET_ND_UINT(83, 256, "Melon::_allowed::_3_1")));
      (((contract_1).user___allowed).data_3_2) =
          (Init_sol_uint256_t(GET_ND_UINT(84, 256, "Melon::_allowed::_3_2")));
      (((contract_1).user___allowed).data_3_3) =
          (Init_sol_uint256_t(GET_ND_UINT(85, 256, "Melon::_allowed::_3_3")));
      (((contract_1).user___allowed).data_3_4) =
          (Init_sol_uint256_t(GET_ND_UINT(86, 256, "Melon::_allowed::_3_4")));
      (((contract_1).user___allowed).data_3_5) =
          (Init_sol_uint256_t(GET_ND_UINT(87, 256, "Melon::_allowed::_3_5")));
      (((contract_1).user___allowed).data_3_6) =
          (Init_sol_uint256_t(GET_ND_UINT(88, 256, "Melon::_allowed::_3_6")));
      (((contract_1).user___allowed).data_3_7) =
          (Init_sol_uint256_t(GET_ND_UINT(89, 256, "Melon::_allowed::_3_7")));
      (((contract_1).user___allowed).data_4_0) =
          (Init_sol_uint256_t(GET_ND_UINT(90, 256, "Melon::_allowed::_4_0")));
      (((contract_1).user___allowed).data_4_1) =
          (Init_sol_uint256_t(GET_ND_UINT(91, 256, "Melon::_allowed::_4_1")));
      (((contract_1).user___allowed).data_4_2) =
          (Init_sol_uint256_t(GET_ND_UINT(92, 256, "Melon::_allowed::_4_2")));
      (((contract_1).user___allowed).data_4_3) =
          (Init_sol_uint256_t(GET_ND_UINT(93, 256, "Melon::_allowed::_4_3")));
      (((contract_1).user___allowed).data_4_4) =
          (Init_sol_uint256_t(GET_ND_UINT(94, 256, "Melon::_allowed::_4_4")));
      (((contract_1).user___allowed).data_4_5) =
          (Init_sol_uint256_t(GET_ND_UINT(95, 256, "Melon::_allowed::_4_5")));
      (((contract_1).user___allowed).data_4_6) =
          (Init_sol_uint256_t(GET_ND_UINT(96, 256, "Melon::_allowed::_4_6")));
      (((contract_1).user___allowed).data_4_7) =
          (Init_sol_uint256_t(GET_ND_UINT(97, 256, "Melon::_allowed::_4_7")));
      (((contract_1).user___allowed).data_5_0) =
          (Init_sol_uint256_t(GET_ND_UINT(98, 256, "Melon::_allowed::_5_0")));
      (((contract_1).user___allowed).data_5_1) =
          (Init_sol_uint256_t(GET_ND_UINT(99, 256, "Melon::_allowed::_5_1")));
      (((contract_1).user___allowed).data_5_2) =
          (Init_sol_uint256_t(GET_ND_UINT(100, 256, "Melon::_allowed::_5_2")));
      (((contract_1).user___allowed).data_5_3) =
          (Init_sol_uint256_t(GET_ND_UINT(101, 256, "Melon::_allowed::_5_3")));
      (((contract_1).user___allowed).data_5_4) =
          (Init_sol_uint256_t(GET_ND_UINT(102, 256, "Melon::_allowed::_5_4")));
      (((contract_1).user___allowed).data_5_5) =
          (Init_sol_uint256_t(GET_ND_UINT(103, 256, "Melon::_allowed::_5_5")));
      (((contract_1).user___allowed).data_5_6) =
          (Init_sol_uint256_t(GET_ND_UINT(104, 256, "Melon::_allowed::_5_6")));
      (((contract_1).user___allowed).data_5_7) =
          (Init_sol_uint256_t(GET_ND_UINT(105, 256, "Melon::_allowed::_5_7")));
      (((contract_1).user___allowed).data_6_0) =
          (Init_sol_uint256_t(GET_ND_UINT(106, 256, "Melon::_allowed::_6_0")));
      (((contract_1).user___allowed).data_6_1) =
          (Init_sol_uint256_t(GET_ND_UINT(107, 256, "Melon::_allowed::_6_1")));
      (((contract_1).user___allowed).data_6_2) =
          (Init_sol_uint256_t(GET_ND_UINT(108, 256, "Melon::_allowed::_6_2")));
      (((contract_1).user___allowed).data_6_3) =
          (Init_sol_uint256_t(GET_ND_UINT(109, 256, "Melon::_allowed::_6_3")));
      (((contract_1).user___allowed).data_6_4) =
          (Init_sol_uint256_t(GET_ND_UINT(110, 256, "Melon::_allowed::_6_4")));
      (((contract_1).user___allowed).data_6_5) =
          (Init_sol_uint256_t(GET_ND_UINT(111, 256, "Melon::_allowed::_6_5")));
      (((contract_1).user___allowed).data_6_6) =
          (Init_sol_uint256_t(GET_ND_UINT(112, 256, "Melon::_allowed::_6_6")));
      (((contract_1).user___allowed).data_6_7) =
          (Init_sol_uint256_t(GET_ND_UINT(113, 256, "Melon::_allowed::_6_7")));
      (((contract_1).user___allowed).data_7_0) =
          (Init_sol_uint256_t(GET_ND_UINT(114, 256, "Melon::_allowed::_7_0")));
      (((contract_1).user___allowed).data_7_1) =
          (Init_sol_uint256_t(GET_ND_UINT(115, 256, "Melon::_allowed::_7_1")));
      (((contract_1).user___allowed).data_7_2) =
          (Init_sol_uint256_t(GET_ND_UINT(116, 256, "Melon::_allowed::_7_2")));
      (((contract_1).user___allowed).data_7_3) =
          (Init_sol_uint256_t(GET_ND_UINT(117, 256, "Melon::_allowed::_7_3")));
      (((contract_1).user___allowed).data_7_4) =
          (Init_sol_uint256_t(GET_ND_UINT(118, 256, "Melon::_allowed::_7_4")));
      (((contract_1).user___allowed).data_7_5) =
          (Init_sol_uint256_t(GET_ND_UINT(119, 256, "Melon::_allowed::_7_5")));
      (((contract_1).user___allowed).data_7_6) =
          (Init_sol_uint256_t(GET_ND_UINT(120, 256, "Melon::_allowed::_7_6")));
      (((contract_1).user___allowed).data_7_7) =
          (Init_sol_uint256_t(GET_ND_UINT(121, 256, "Melon::_allowed::_7_7")));
    }
    if (GET_ND_RANGE(124, 0, 2, "take_step")) {
      ((blocknum).v) = (GET_ND_INCREASE(122, (blocknum).v, 1, "blocknum"));
      ((timestamp).v) = (GET_ND_INCREASE(123, (timestamp).v, 1, "timestamp"));
    }
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(125, 0, 17, "next_call"));
    prev_bal = Read_Map_1(&contract_1.user___balances, Init_sol_address_t(g_literal_address_1));
    call_1 = 0;
    call_2 = 0;
    call_3 = 0;
    switch (next_call) {
    case 0: {
      ...
      sol_address_t arg__newCouncil =
          Init_sol_address_t(GET_ND_RANGE(1, 0, 8, "_newCouncil"));
    ...
    case 1: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(2, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg__initialReceiver =
          Init_sol_address_t(GET_ND_RANGE(3, 0, 8, "_initialReceiver"));
    ...
    case 2: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(4, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
    ...
    case 3: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(5, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
    ...
    case 4: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(6, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
    ...
    case 6: {
      ...
      call_2 = 1;
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(8, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
    ...
    case 7: {
      ...
      sol_address_t arg_from =
          Init_sol_address_t(GET_ND_RANGE(11, 0, 8, "from"));
      sol_uint256_t arg_value =
    ...
    case 9: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(14, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_owner =
          Init_sol_address_t(GET_ND_RANGE(15, 0, 8, "owner"));
    ...
    case 10: {
      ...
      ((value).v) = (0);
      sol_address_t arg_owner =
          Init_sol_address_t(GET_ND_RANGE(17, 0, 8, "owner"));
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(18, 0, 8, "spender"));
    ...
    case 11: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(19, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_to = Init_sol_address_t(GET_ND_RANGE(20, 0, 8, "to"));
      sol_uint256_t arg_value =
    ...
    case 12: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(22, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(23, 0, 8, "spender"));
      sol_uint256_t arg_value =
    ...
    case 13: {
      ...
      ((value).v) = (0);
      sol_address_t arg_from =
          Init_sol_address_t(GET_ND_RANGE(26, 0, 8, "from"));
      sol_address_t arg_to = Init_sol_address_t(GET_ND_RANGE(27, 0, 8, "to"));
      sol_uint256_t arg_value =
    ...
    case 14: {
      smartace_log("[Calling bad(from, to, value) on contract_1]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(29, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_from =
          Init_sol_address_t(GET_ND_RANGE(30, 0, 8, "from"));
      sol_address_t arg_to = Init_sol_address_t(GET_ND_RANGE(31, 0, 8, "to"));
      sol_uint256_t arg_value =
          Init_sol_uint256_t(GET_ND_UINT(32, 256, "value"));
      ERC20_Method_For_Melon_bad(&(contract_1), sender, value, blocknum,
                                 timestamp, paid, sender, arg_from, arg_to,
                                 arg_value);
      smartace_log("[Call successful]");
      break;
    }
    case 15: {
      ...
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(34, 0, 8, "spender"));
      sol_uint256_t arg_addedValue =
          Init_sol_uint256_t(GET_ND_UINT(35, 256, "addedValue"));
    ...
    case 16: {
      smartace_log("[Calling decreaseAllowance(spender, subtractedValue) on "
                   "contract_1]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(36, 2, 8, "sender"));
      ((last_sender).v) = ((sender).v);
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(37, 0, 8, "spender"));
      sol_uint256_t arg_subtractedValue =
          Init_sol_uint256_t(GET_ND_UINT(38, 256, "subtractedValue"));
    ...
    post_bal = Read_Map_1(&contract_1.user___balances, Init_sol_address_t(g_literal_address_1));
    if (prev_bal.v > post_bal.v)
    {
      sol_assert(curr_sender.v == g_literal_address_1 || call_1  || call_2 || call_3, 0);
    }
  }
}