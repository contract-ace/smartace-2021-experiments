...
void run_model(void) {
  ...
  while (sol_continue()) {
    sol_on_transaction();
    sol_uint256_t last = contract_1.user___totalSupply;
    sol_bool_t bearer;
    ...
    case 0: {
      ...
      bearer = Read_Map_3(&contract_1.user___minters.user_bearer, sender);
    ...
    sol_assert(last.v == contract_1.user___totalSupply.v || bearer.v, 0);
  }
}