...
void Crowdsale_Method_bad(struct Crowdsale *self, sol_address_t sender,
                          sol_uint256_t value, sol_uint256_t blocknum,
                          sol_uint256_t timestamp, sol_bool_t paid,
                          sol_address_t origin) {
  ((self->user_goal).v) = (0);
...
void run_model(void) {
  ...
  ((blocknum).v) = (GET_ND_UINT(13, 256, "blocknum"));
  sol_uint256_t timestamp;
  ((timestamp).v) = (GET_ND_UINT(14, 256, "timestamp"));
  sol_bool_t paid;
  ((paid).v) = (1);
  ...
  (g_literal_address_3735928559) =
      (GET_ND_RANGE(15, 1, 9, "g_literal_address_3735928559"));
  ...
  if (GET_ND_RANGE(18, 0, 2, "take_step")) {
    ((blocknum).v) = (GET_ND_INCREASE(16, (blocknum).v, 1, "blocknum"));
    ((timestamp).v) = (GET_ND_INCREASE(17, (timestamp).v, 1, "timestamp"));
  }
  {
    sol_address_t sender;
    ((sender).v) = (GET_ND_RANGE(19, 3, 9, "sender"));
  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      (((contract_2)->user_deposits).data_0) =
          (Init_sol_uint256_t(GET_ND_UINT(20, 256, "Escrow::deposits::_0")));
      (((contract_2)->user_deposits).data_1) =
          (Init_sol_uint256_t(GET_ND_UINT(21, 256, "Escrow::deposits::_1")));
      (((contract_2)->user_deposits).data_2) =
          (Init_sol_uint256_t(GET_ND_UINT(22, 256, "Escrow::deposits::_2")));
      (((contract_2)->user_deposits).data_3) =
          (Init_sol_uint256_t(GET_ND_UINT(23, 256, "Escrow::deposits::_3")));
      (((contract_2)->user_deposits).data_4) =
          (Init_sol_uint256_t(GET_ND_UINT(24, 256, "Escrow::deposits::_4")));
      (((contract_2)->user_deposits).data_5) =
          (Init_sol_uint256_t(GET_ND_UINT(25, 256, "Escrow::deposits::_5")));
      (((contract_2)->user_deposits).data_6) =
          (Init_sol_uint256_t(GET_ND_UINT(26, 256, "Escrow::deposits::_6")));
      (((contract_2)->user_deposits).data_7) =
          (Init_sol_uint256_t(GET_ND_UINT(27, 256, "Escrow::deposits::_7")));
      (((contract_2)->user_deposits).data_8) =
          (Init_sol_uint256_t(GET_ND_UINT(28, 256, "Escrow::deposits::_8")));
    }
    if (GET_ND_RANGE(31, 0, 2, "take_step")) {
      ((blocknum).v) = (GET_ND_INCREASE(29, (blocknum).v, 1, "blocknum"));
      ((timestamp).v) = (GET_ND_INCREASE(30, (timestamp).v, 1, "timestamp"));
    }
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(32, 0, 8, "next_call"));
    switch (next_call) {
    case 0: {
    ...
    case 1: {
      ...
      sol_uint256_t value;
      ((value).v) = (0);
      Crowdsale_Method_bad(&(contract_1), sender, value, blocknum, timestamp,
                           paid, sender);
      smartace_log("[Call successful]");
      break;
    }
    ...
    case 3: {
      ...
      sol_address_t arg_p = Init_sol_address_t(GET_ND_RANGE(7, 0, 9, "p"));
    ...
    case 5: {
      ...
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_p = Init_sol_address_t(GET_ND_RANGE(10, 0, 9, "p"));
