...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    call_2 = 0;
    call_3 = 0;
    sol_address_t watched;
    watched.v = (GET_ND_RANGE(113, 0, 7, "watched"));
    prev_bal = Read_Map_1(&contract_1.user___balances, watched);
    switch (next_call) {
    case 0: {
    ...
    post_bal = Read_Map_1(&contract_1.user___balances, watched);
    if (prev_bal.v > post_bal.v)
    {
      sol_assert(last_sender.v == watched.v || call_1  || call_2 || call_3, 0);
    }
  }
}