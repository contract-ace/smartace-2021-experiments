  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      ...
      case 0: {
        sol_raw_uint8_t v0;
        uint64_t entry_id;
        (entry_id) = (GET_ND_RANGE(39, 0, 6, "entry"));
        switch (entry_id) {
        case 0: {
          uint8_t guard;
          (guard) = (0);
          ...
          (v0) = (((((contract_1).user___minters).user_bearer).data_0).v);
          break;
        }
        case 1: {
          uint8_t guard;
          ...
          (guard) = (1);
          sol_require(guard, "Guard");
          (v0) = (((((contract_1).user___minters).user_bearer).data_1).v);
          break;
        }
        case 2: {
          uint8_t guard;
      ...
      case 1: {
        ...
        uint64_t entry_id;
        (entry_id) = (GET_ND_RANGE(40, 0, 6, "entry"));
        switch (entry_id) {
        case 0: {
          uint8_t guard;
          (guard) = (0);
      ...
      case 2: {
        sol_raw_uint256_t v0;
        uint64_t entry_id;
        (entry_id) = (GET_ND_RANGE(41, 0, 36, "entry"));
        switch (entry_id) {
        case 0: {
          uint8_t guard;
          (guard) = (0);
          (guard) = (1);
          sol_require(guard, "Guard");
          (v0) = ((((contract_1).user___allowances).data_0_0).v);
          break;
        }
        case 1: {
          uint8_t guard;
          ...
          (guard) = (1);
          sol_require(guard, "Guard");
          (v0) = ((((contract_1).user___allowances).data_0_1).v);
          break;
        }
        case 2: {
          uint8_t guard;
        ...
        case 6: {
          ...
          (guard) = (1);
          sol_require(guard, "Guard");
          (v0) = ((((contract_1).user___allowances).data_1_0).v);
          break;
        }
        case 7: {
          uint8_t guard;
          ...
          (guard) = (1);
          sol_require(guard, "Guard");
          (v0) = ((((contract_1).user___allowances).data_1_1).v);
          break;
        }
        case 8: {
          uint8_t guard;
    ...
    case 9: {
      ...
      sol_uint256_t last = Read_Map_1(&contract_1.user___balances, pos);
      ERC20_Method_For_Token_transfer(&(contract_1), sender, value, blocknum,
                                      timestamp, paid, sender, arg_recipient,
                                      arg_amount);
      sol_uint256_t next = Read_Map_1(&contract_1.user___balances, pos);
      if (last.v > next.v) {
